const steps = [
  ...
  },
  {
    ...
    description:
      "Créez des rituels financiers réguliers. Une fois par semaine, prenez 10 minutes pour ajuster et planifier.",
  },
  {
    number: "03",
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            Comme une roue fluide qui avance à votre rythme
          </p>
        </div>
