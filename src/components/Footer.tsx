      ...
      <div className="container mx-auto px-6">
        ...
        duration: 0.6
          ...
          <nav className="flex flex-wrap justify-center gap-6 text-sm text-muted-foreground">
            {links.map((link, index) => <motion.div key={link.to} initial={{
            opacity: 0,
            y: 10
          }} whileInView={{
            opacity: 1,
            ...
            <motion.a href="mailto:contact@steero.fr" className="hover:text-primary transition-colors" initial={{
            opacity: 0,
            y: 10
          }} whileInView={{
            opacity: 1,
          ...
          duration: 0.5,
          delay: 0.3
        }} className="text-sm text-muted-foreground">© 2026 Steero. Tous droits réservés.</motion.p>
        </motion.div>
      </div>
    </footer>;
};
