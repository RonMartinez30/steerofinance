...
const features = [
  {
    ...
    title: "Budgétiser",
    description:
      "Tes ressources sont limitées : elles te permettent de construire le présent et de préparer l’avenir. Définissons ensemble ce cadre essentiel à l’aide de budgets clairs, conçus pour t’aider à avancer vers ta destination.",
  },
  {
    icon: Settings,
    title: "Traquer",
    description:
      "Contrairement à d’autres applications, Steero ne fait pas à ta place. La saisie manuelle crée un lien émotionnel : elle rend le coût psychologiquement réel, ce qui améliore significativement l’autorégulation… et donc la qualité de tes décisions financières.",
  },
  {
    icon: TrendingUp,
    title: "Ritualiser",
