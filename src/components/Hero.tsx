        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className="space-y-8">
            ...
            <p className="text-lg text-muted-foreground max-w-xl">
              Aidez tout le monde à reprendre le contrôle de ses finances avec 
              simplicité, en cultivant la régularité et la clarté plutôt que 
              la complexité et la culpabilité.
            </p>
