        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-4">
              {[
                { icon: Timer, title: "Simplicité", desc: "Un rituel de suivi en moins de 2 minutes par jour" },
                { icon: Eye, title: "Clarté", desc: "Tu sais exactement pourquoi tu dépenses et où tu vas" },
                { icon: ShieldCheck, title: "Sérénité", desc: "Plus de surprises en fin de mois" }
              ].map((item, index) => (
                <motion.div 
                  key={index}
                  initial={{ opacity: 0, y: 30 }}
